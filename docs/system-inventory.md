...
| 3=   | `harness-failures-log`   | Failures log + `/failures` page  | 0   | 8      | 800      | [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08)             | Feeds T-002's known-failure-pattern signal. Self-repair + safety agent both write to it. Auto-syncs to CLAUDE.md component #4. |
...
| `harness-failures-log`        | Failures log + `/failures` cockpit page | design-only | 0   | 8      | 800      | Spec at [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08). Dependency of T-002's known-failure regex signal. Auto-syncs to `docs/claude-md/failures.md` for CLAUDE.md component #4 |
