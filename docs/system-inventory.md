...
| 3    | `safety-agent`           | Pre-flight safety review         | 80  | 8      | 160      | [T-002](leverage-targets.md#safety-agent-0--done)                               | Sub-phases A+B+C+D live: 0162 + 5 signals + scorer + router + E2E + twin arbiter route (`/api/twin/safety-arbitrate`) + driver orchestrator + 181 tests. Gate-runner wire-up + surfacing + 3-PR integration test up next (sub-phase E). |
...
| `harness-safety-agent`      | Six-signal risk score + Twin arbiter + Puppeteer E2E | partial | 80  | 8      | 160      | Sub-phases A+B+C+D live: 0162 + 5 signals + scorer + router + E2E + twin arbiter + driver + 181 tests. Spec: `docs/leverage-targets.md#safety-agent-0--done`. |
