...
| Autonomous harness                                | 40           | 242          | 171.6             | **70.9%**  |
...
| 3=   | `harness-failures-log`   | Failures log + `/failures` page  | 33  | 8      | 536      | [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08)             | Phase 1a shipped 2026-05-08. Phase 1b (cron + backfill) and 1c (cockpit page) pending.              |
...
| `harness-failures-log`        | Failures log + `/failures` cockpit page | partial     | 33  | 8      | 536      | Phase 1a shipped 2026-05-08: migration `0161_failures_log` + `lib/failures/{log,signature}.ts` + `POST /api/failures/log` + self-repair detector integration. 80 tests green. Phase 1b (cron + backfill) and 1c (cockpit page) pending. Spec at [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08) |
