...
| 3    | `safety-agent`           | Pre-flight safety review         | 60  | 8      | 320      | [T-002](leverage-targets.md#safety-agent-0--done)                               | Sub-phases A+B+C live: 0162 + 5 signals + scorer + router + Puppeteer E2E runner (injectable browser) + test-user resolver + failure archival + 153 tests. Twin arbiter + gate integration up next. |
...
| `harness-safety-agent`      | Six-signal risk score + Twin arbiter + Puppeteer E2E | partial | 60  | 8      | 320      | Sub-phases A+B+C live: 0162 + 5 signals + scorer + router + E2E runner (injectable browser) + test-user resolver + archival + 153 tests. Spec: `docs/leverage-targets.md#safety-agent-0--done`. |
