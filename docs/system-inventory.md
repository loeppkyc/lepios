...
| 3    | `safety-agent`           | Pre-flight safety review         | 20  | 8      | 640      | [T-002](leverage-targets.md#safety-agent-0--done)                               | Sub-phase A landed: migration 0162 (plan_loc + safety_decisions + weights) + 4 signal modules (secret/schema/scope/failures-pattern) + 66 tests. Coverage delta + scorer + router up next. |
...
| `harness-safety-agent`      | Six-signal risk score + Twin arbiter + Puppeteer E2E | partial | 20  | 8      | 640      | Sub-phase A live: migration 0162 + `lib/harness/safety/v2/{types,signals/*}` + 66 tests. Spec: `docs/leverage-targets.md#safety-agent-0--done`. |
