...
| Autonomous harness                                | 40           | 242          | 174.3             | **72.0%**  |
...
| 3=   | `harness-failures-log`   | Failures log + `/failures` page  | 66  | 8      | 272      | [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08)             | Phase 1a + 1b shipped 2026-05-08. Phase 1c (cockpit page) pending.                                  |
...
| `harness-safety-agent`      | Pre-commit + pre-handoff safety review  | design-only | 0   | 8      | 800      | `docs/specs/safety-agent.md`, task `9b9bca02` queued                             |
...
| `harness-failures-log`        | Failures log + `/failures` cockpit page | partial     | 66  | 8      | 272      | Phase 1a + 1b shipped 2026-05-08. 1a: schema + write paths + recurrence detector (80 tests). 1b: `lib/failures/export-markdown.ts` + night-tick integration + 8 backfilled F-N entries (13 tests). Markdown source-of-truth flipped: table → render. Phase 1c (cockpit page) pending. Spec at [T-006](leverage-targets.md#t-006--failures-log-revised-2026-05-08) |
