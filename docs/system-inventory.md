...
| `harness-safety-agent`      | Six-signal risk score + Twin arbiter + Puppeteer E2E | shipped | 95  | 8      | 40       | A–E shipped 2026-05-08. 0162 + 5 signals + scorer + router + E2E + twin arbiter + driver + F-N10 fix + 3-PR integration test + 191 tests. Deferred: gate-runner wire-up + morning_digest + /autonomous counter (v2.1). |
