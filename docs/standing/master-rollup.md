...
**Last updated:** 2026-05-01 (coordinator audit session)
**Updated by:** read-only audit across all source docs; no code or DB changes
...
**Rollup: 67.0 / 100** · source: `docs/gpu-day-readiness.md`, last updated 2026-04-27
...
|---|---|---|---|---|
| B4 — cloudflared as Windows service | B | 8 | **0%** | Blocks all Ollama production traffic |
...
| **3** | B4 — cloudflared tunnel as Windows service | T5 | Setup ~1h | 8.0 GPU | Unlocks ollama_daytime (T1, 1 pt remaining) + all prod Ollama traffic | Blocks every Ollama-dependent feature in production |
...
*Source docs: `harness_components` (DB), `product_components` (DB), `task_queue` (DB), `docs/lepios/amazon-pipeline-rollup.md`, `docs/standing/active-state.md`, `docs/gpu-day-readiness.md`, `docs/streamlit-port-catalog.md`, `docs/harness/PENDING_ADDITIONS.md`, `docs/acceptance/local-sales-webhook.md`*
