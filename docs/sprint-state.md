...
source_label: "postmortem_915d1fee"
status: "awaiting-colin-approval"
description: "Branch pre-configuration on coordinator trigger — eliminate start-wrong-correct pattern"
acceptance_doc: "docs/sprint-5/h5-branch-preconfig-acceptance.md"
approach: "Part A: Colin updates Routine system prompt (Step 0 git checkout). Part B: builder updates coordinator.md branch guard to log branch_guard_passed on success path. Part C: builder adds BRANCH: line to invoke-coordinator.ts fire payload."
colin_required_for: "Part A — Routine system prompt update in Anthropic console. 4 open questions in acceptance doc."
branch: "harness/task-844c49f2-1fe8-4026-a236-9fd3cfd9807d"
opened_at: "2026-05-10T03:10:00Z"
last_updated_at: "2026-05-10T03:10:00Z"
