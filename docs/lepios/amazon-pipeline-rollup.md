...
| 14        | GST UI / business-review surfacing                   | 4       | 65%        | 2.60         | statement coverage fully featured (overrides, no_activity, filename attribution, auth errors); business-review Today panel fixed (pending sub-line, month mapping, auto-refresh, Dev Mode) |
