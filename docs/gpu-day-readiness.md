...
**1.8 pts remaining.** A2 closed 2026-05-14 (+1.0 pt).
A4 closes once `powercfg /change standby-timeout-ac 0` is run and 3 clean overnight ticks confirm.
Also set `DAYTIME_TICK_ENABLED=1` in Vercel to activate the daytime tick.
